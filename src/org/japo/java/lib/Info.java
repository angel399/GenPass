...
public class Info {
    ...
    public boolean comprobarFecha(int dia, int mes, int any) {
    ...
    public static boolean validarLetraDNI(int dni, char dniLetra) {
        String LETRAS = "TRWAGMYFPDXBNJZSQVHLCKE"; 
        return LETRAS.charAt((dni % 22) - 1) == dniLetra;
    }
    ...
    public static boolean validarMinuto(int m) {
        return m >= 0 && m <= 59;
    }
    
    public static boolean validarSegundo(int s) {
        return s >= 0 && s <= 59;
    }
}
